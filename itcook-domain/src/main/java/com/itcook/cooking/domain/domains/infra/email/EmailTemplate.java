...
import static com.itcook.cooking.domain.domains.infra.email.EmailHtmlConstant.MAIL_BASIC_FORMAT;
...
public enum EmailTemplate {
    ...
    AUTH_EMAIL("잇쿡 이메일 인증 요청입니다.", MAIL_BASIC_FORMAT.formatted(
        "  <br>\n" +
            "  <br>\n" +
            "  <span style=\"font-size:18px;\">안녕하세요, 잇쿡에 오신 환영합니다! <br>요청하신 인증코드는 아래와 같습니다 <br>\n" +
