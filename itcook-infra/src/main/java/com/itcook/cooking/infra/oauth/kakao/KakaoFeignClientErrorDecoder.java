...
public class KakaoFeignClientErrorDecoder implements ErrorDecoder {
    ...
    public Exception decode(String methodKey, Response response) {
        ...
        log.error("카카오 소셜 로그인 Feign API Feign Client 호출 중 오류가 발생되었습니다. body: {}", bodyString);

        return new ApiException(CommonErrorCode.BAD_REQUEST, "카카오 소셜 로그인 Feign API Feign Client 호출 오류");
    }
}
